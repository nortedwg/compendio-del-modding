...
![Edit menu mostrando Preferences](./img/image57.png)

En este panel podemos editar cualquier atajo de teclado del programa.

![Panel Blender Preferences - Keybinding](./img/image76.png)
...
![Cubo con ejes gizmo de transformación](./img/image23.png)
...
![Resultado de la tecla i en modo Shading](./img/image71.gif)
...
![Modo videojuego / fly mode en Blender](./img/image53.gif)
...
![Tecla FIN - eliminar cara en modo editar](./img/image8.gif)
...
![Panel Keymap con botón Import](./img/image77.gif)
...
![Vista centrada en el objeto con . SUPR](./img/image70.png)

### Otros

**`TAB`** — Modo editar. Para editar un objeto.

![Modo editar activado con TAB](./img/image16.gif)

**`1, 2 y 3`** — Dentro del modo editar, para seleccionar un vertex (vértice), edge (borde) y face (cara) respectivamente.

![Selección de vertex, edge y face](./img/image42.gif)
...
![Resultado de duplicar un objeto](./img/image82.gif)
...
![Objeto aislado en la vista](./img/image6.gif)
...
![Símbolo del cursor 3D](./img/image88.gif)
...
![Panel Snap con opciones de cursor 3D](./img/image48.png)
...
![Ejemplo de combinación cursor y atajos](./img/image60.png)
...
![Panel de Add-ons con QuickSnap instalado](./img/image89.gif)
...
![Ejemplo de QuickSnap moviendo vértice a vértice](./img/image18.png)
...
![Panel WoW Atajos Útiles](./img/image78.gif)
...
![Resultado de ALT+R rotando 90 grados](./img/image19.png)
...
![Panel Texturas del WMO Automáticas](./img/image9.gif)
...
![Mansión Waycrest importada en Blender](./img/image47.png)
...
![Panel de materiales con material seleccionado](./img/image5.png)
...
![Botón Select destacado](./img/image49.png)

![Todas las caras del pilar seleccionadas en naranja](./img/image27.png)

Pulso la tecla **`P`** para separar ese material en otro objeto.

![Menú Separate con opción Selection](./img/image30.png)
...
![Outliner mostrando el objeto .001](./img/image3.png)
...
![Pilares aislados en la vista](./img/image17.png)
...
![Vista detallada de las piezas del pilar](./img/image11.gif)
...
![Pilar con hueco en el centro](./img/image79.png)

![Menú Snap To con Vertex seleccionado](./img/image62.png)

![Pilar reparado sin hueco](./img/image52.png)
...
![Nodo Image Texture conectado a Principled BSDF](./img/image32.png)

En este caso una textura de madera:

![Selector de archivo con texturas de Waycrest](./img/image50.png)
...
![Opción Materiales sin brillo en el AddOn](./img/image33.png)

:::tip[Consejo]
En el material, ponle el mismo nombre que la textura. Sé ordenado porque luego te hará falta. Lo puedes copiar y pegar.
:::

![Material renombrado igual que la textura](./img/image85.png)

Vamos a la pestaña **UV Editing** para ajustar su UV:

![Pestaña UV Editing destacada](./img/image69.png)

![Espacio de trabajo UV Editing con la pared](./img/image86.gif)
...
![Panel UV con caras seleccionadas](./img/image55.png)

En el panel superior de UV seleccionamos una de las siguientes opciones:

![Menú UV con las opciones de proyección](./img/image22.gif)
...
![Project from View - UV perpendicular a la pared](./img/image7.png)
...
![Botón de visibilidad de caras en el editor UV](./img/image14.png)
...
![Editor UV con pared ajustada a la textura](./img/image41.gif)

Finalmente me ha quedado así:

![Resultado final de la UV ajustada](./img/image43.png)
...
![Puerta importada junto a la sala](./img/image83.gif)

Lo primero es colocar la puerta en su posición definitiva.

![Puerta colocada en la posición definitiva](./img/image80.gif)
...
![Herramienta Loop Cut en el panel](./img/image1.png)
...
![Proceso completo con cortes a ambos lados](./img/image63.png)

![Vista de los tres cortes realizados](./img/image61.png)

Ajustamos la posición y quedará así:

![Marco de puerta ajustado en los cortes](./img/image39.gif)
...
![Resultado final - hueco en la pared con el arco de puerta](./img/image40.gif)
...
![Overlay con Face Orientation activado](./img/image72.png)

Lo **rojo** es la cara que **no** se ve. Lo **azul** la que **sí**.

![Sala con normal maps en rojo y azul](./img/image15.gif)
...
![Menú Mesh > Normals > Flip](./img/image59.png)

![Resultado después del Flip](./img/image58.png)

Nos aseguramos de que desde el interior siempre veamos el color azul:

![Vista interior toda en azul](./img/image75.png)
...
![Diagrama visible / visible ambos lados / no visible](./img/image25.gif)
...
![Panel WMO Groups en wow.export](./img/image37.png)
...
![Overlay Statistics activado](./img/image21.png)

![Panel de estadísticas con conteo de vértices y caras](./img/image35.png)
